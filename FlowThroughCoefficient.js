...
// Estbalish a FlowThroughCoefficientQuery f(x) to connect to 'wMVP3_CapeCodMA' & get a response
var  FlowThroughCoefficientQuery = function (res, query) {
...
//GET API
app.get('/api/FlowThroughCoefficient', function(req , res) {
  var query = 'select * from CapeCodMA.FTCoeff';
  FlowThroughCoefficientQuery (res, query);
});
