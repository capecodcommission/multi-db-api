...
// Define the HTTP 'GET' method - access through server port + /WastewaterSource3
...
sql.connect(config, function (err) {
  ...
  var wMVP3_CapeCodMARequest = new sql.Request();
    ...
    wMVP3_CapeCodMARequest.query('select top 10000 * from WastewaterSource3', function (err, recordset) {
